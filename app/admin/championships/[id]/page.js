  ...
  if (!loading && championship)
    return (
      <div className="bg-white p-4 relative min-h-screen w-full text-gray-950 py-44 font">
        ...
        <div className=" bg-white w-7/12 mx-auto flex flex-col items-center">
          <div className="flex items-center w-full justify-between">
            ...
            <button
              ...
              className="bg-green-300 text-xs hover:scale-105 transition-all inline-flex items-center gap-1 justify-center text-black p-2 rounded-md"
            >
              <svg
          ...
          {/* ********************************************************* */}
          {/* ADAUGARE MECI IN ARRAY + REQUEST PUT CATRE SERVER */}
          {/* ********************************************************* */}
          {addMatchModal && (
        ...
        {/* ********************************************************* */}
        {/* COMPENTA DE EDITAT UN MECI + PUT REQUEST CATRE SERVER  */}
        {/* ********************************************************* */}
            ...
            {!successModal && (
              <form
                ...
                onSubmit={(e) => {
                  ...
                  let newMatchesArr = [selectedMatch];
                  // write a function to add the other matches but the selected one
                  championship.matches.forEach((match) => {
                    if (
                      match.team1 !== selectedMatch.team1 &&
                      match.team2 !== selectedMatch.team2
                    ) {
                      newMatchesArr.push(match);
                    }
                  });

                  const updatedChampionship = {
                    ...championship,
                    matches: newMatchesArr,
                  };
